...
begin
  ...
  select
    ...
    question_explanation.explanation_image_path
  into
    deleted_question_id,
    deleted_question_image_path,
    deleted_explanation_image_path
  from public.questions as question
  left join public.question_explanations as question_explanation
    on question_explanation.question_id = question.id
